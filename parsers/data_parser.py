    ...
    for index, item in enumerate(data['items']):
        ...
        for item2 in item['fedprojects']:
            ...
            if subsidies_count > 0:
                ...
                subsidies_info('https://api.spending.gov.ru/v1/natprojects/fpsubsidies?fp_id=%s&page=' % (api_fp_id),
                               api_fp_id, proj_id, subs_id, pages)
...
url_api = 'https://api.spending.gov.ru/v1/natprojects/nprojects/'
get_national_and_federal_projects_info(url_api)
